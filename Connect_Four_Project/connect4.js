 ...
 */
// The makeBoard function creates an array of arrays. The outer array will contain the entire game board, which will contain the 
...
//Lines 29 and 30: pushes seven null values (the desired width of the game board) into the row arrays just created.  
...
// PART 1 of the makeHtmlBoard function is creating the top HTML table row and cells that will appear in dotted style above
// the board and function as the clickable cells of the columns the players will drop their pieces into.
// Line 44: gets the "board" variable from the <table> element in HTML w/ID of "board"
...
// Line 55: iterates 7 times to create the number of cells equal to the width specified above
...
// Line 71: iterates 6 times (equal to the desired height of the game board) to create the remaining rows
...
// When the user clicks on a column in the top row, the findSpotForCol iterates through the cells in the 
